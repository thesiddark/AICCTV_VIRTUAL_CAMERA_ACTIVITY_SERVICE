...
for i in res:
    s=i["photo"]
    s=s.replace("/media/","")
    pth="C:\\Users\\Acer\\PycharmProjects\\FACETRACK_MAJLIS\\media\\"+ s
...
while(True):
    ...
    cv2.imwrite(r"C:\\Users\\Acer\\PycharmProjects\\FACETRACK_MAJLIS\\media\\tests\\b.jpg",frame)
    cv2.imshow('frame', frame)
    if cv2.waitKey(1) & 0xFF == ord('q'):
        break
    picture_of_others = face_recognition.load_image_file(r"C:\\Users\\Acer\\PycharmProjects\\FACETRACK_MAJLIS\\media\\tests\\b.jpg")
    # print(pth)
